 ...
 *   cd ~/piza/piza-api
 *   docker compose -f docker-compose.prod.yml exec -T api node docs/benny-boys/delete-stores.mjs --list
 *   docker compose -f docker-compose.prod.yml exec -T api node docs/benny-boys/delete-stores.mjs --all
 *   docker compose -f docker-compose.prod.yml exec -T api node docs/benny-boys/delete-stores.mjs benny-boys bunny-boys leovorno
 */
